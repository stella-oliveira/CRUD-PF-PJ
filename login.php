                            ...
                            <div class="panel-body">                                
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-12">
                                            ...
                                            <div class="validar">
                                                <input type="text" class="form-control" id="usuario" name="usuario" placeholder="Digite seu usuário" autofocus value="<?= isset($usuario)?$usuario:'' ?>" />
                                            </div>
                                        </div>
                                        <div class="form-group col-md-12">
                                            <label for="senha">Senha</label>
                                                <div class="validar">
                                                    <input type="password" class="form-control" id="senha" name="senha" placeholder="Digite sua senha" value="<?= isset($senha)?$senha:'' ?>" />
                                                </div>
                                        </div>
                                    </div> 
