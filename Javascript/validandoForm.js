...
$( document ).ready( function () {
	...
	$( "#formularioCNPJ" ).validate( {
		...
		messages: {
			...
			abertura: "O campo é obrigatório.",
			nome: "O campo é obrigatório.",
			fantasia: "O campo é obrigatório.",
			atividade_principal: "O campo é obrigatório.",
			logradouro: "O campo é obrigatório.",
			numero: "O campo é obrigatório.",
			complemento: "O campo é obrigatório.",
			cep: "O campo é obrigatório.",
			bairro: "O campo é obrigatório.",
			municipio: "O campo é obrigatório.",
